...
const {createPost,fetchPosts,fetchPost,updatePost,postComment,
updateValidations,updateImage,deletePost,home,postDetails} = require("../controllers/postController");
